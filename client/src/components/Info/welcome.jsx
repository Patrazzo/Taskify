...
export const Welcome = () => {
  return (
    <div className="flex flex-row phone:flex-col items-center justify-between h-screen phone:h-auto phone:pt-10 w-full dark:bg-taskify-DarkBlue bg-taskify-lightBackground">
