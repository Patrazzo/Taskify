...
export const Info = (props) => {
  ...
  return (
    <div
      className={`flex ${flexRowReverse} ${flexColReverse} phone:flex-col justify-between phone:pb-10 phone:items-center dark:bg-taskify-DarkBlue taskify-lightBackground`}
    >
      ...
      <div className="w-2/4 phone:w-full smallphone:w-full smallphone:text-xs  smallphone:px-1 smallphone:h-auto flex justify-center items-center flex-col p-5">
        <h1 className="text-4xl taskify-Green-text text-center mb-10 drop-shadow">
          {props.heading}
        </h1>
